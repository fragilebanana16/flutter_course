...
import 'package:flutter_course/pages/toolBox/widgets/mh_text_field%20.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart'
    as FlutterScreenUtil;

class WechatSearchBar extends StatefulWidget {
  WechatSearchBar({
    Key? key,
    this.contentPadding =
...
class _SearchBarState extends State<WechatSearchBar> {
  /// widget渲染监听。
...
class _SearchCube extends StatelessWidget {
  const _SearchCube({Key? key, required this.isEdit, required this.isAnimating})
      : super(key: key);
