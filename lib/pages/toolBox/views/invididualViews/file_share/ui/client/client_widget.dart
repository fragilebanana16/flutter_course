...
import 'package:flutter_course/pages/toolBox/views/invididualViews/file_share/entity/download/download_entity.dart';
import 'package:flutter_course/pages/toolBox/views/invididualViews/file_share/entity/download/download_manner.dart';
import 'package:flutter_course/pages/toolBox/views/invididualViews/file_share/entity/download/download_state.dart';
import 'package:flutter_course/pages/toolBox/views/invididualViews/file_share/entity/function_mode.dart';
...
import 'package:flutter_course/pages/toolBox/views/invididualViews/file_share/ui/client/connect_widget.dart';
import 'package:flutter_course/pages/toolBox/views/invididualViews/file_share/ui/client/navigation_widget.dart';
import 'package:flutter_course/pages/toolBox/views/invididualViews/file_share/ui/common_view/two_modes_switcher.dart';
import 'package:flutter_course/pages/toolBox/views/invididualViews/file_share/ui/list_file/list_shared_files_widget.dart';
import 'package:flutter_course/pages/toolBox/views/invididualViews/file_share/util/extension.dart';
...
class _ClientWidgetState extends State<ClientWidget> {
  ...
  _onClickScanButton() async {
    ...
    if (isPermissionGranted) {
      if (mounted) {
        final result =
            await Navigator.of(context).pushNamed<bool>(mScanningPath);
        if (result == true) {
          _syncFiles();
        }
      }
