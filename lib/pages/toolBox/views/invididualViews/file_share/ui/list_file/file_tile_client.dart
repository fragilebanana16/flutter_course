...
import 'package:flutter_course/pages/toolBox/views/invididualViews/file_share/ui/common_view/conditional_parent_widget.dart';
import 'package:flutter_course/pages/toolBox/views/invididualViews/file_share/ui/list_file/file_menu_options.dart';
...
class _FileTileClientState extends State<FileTileClient> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () async {
        ...
        final file =
            File('${widget.sharedFile.savedDir}/${widget.sharedFile.name}');
        if (file.existsSync()) {
          OpenFilex.open(file.path);
        } else {
          context
              .showSnackbar('File does not exist. Please download it first!');
        }
      },
  ...
  _buildChild() => Container(
        ...
        child: Row(
          children: [
            Icon(widget.sharedFile.fileIcon,
