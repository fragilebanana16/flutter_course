...
//   /// 悬浮view 高度 向上取整
//   int _suspensionHeight = (ScreenUtil().setHeight(99.0) as double).ceil();

//   /// 每个item 高度 向上取整
//   int _itemHeight = (ScreenUtil().setHeight(168.0) as double).ceil();
...
//   void _closeSlidable() {
//     // 容错处理
//     if (_slideIsOpen == null || !_slideIsOpen!) return;
...
//       padding: EdgeInsets.only(left: ScreenUtil().setWidth(51.0)),
